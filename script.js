...
// You will need to add this HTML structure to your index.html:
/*
<div id="message-modal" class="modal">
    <div class="modal-content">
        ...
        <div id="message-modal-actions" class="modal-actions">
            <!-- Buttons like OK, Cancel will go here if needed -->
        </div>
    </div>
</div>
*/
...
function renderProducts(products) {
    ...
    products.forEach(product => {
        ...
        const priceDisplay = product.sale && product.salePrice 
            ? `<span class="original-price">₱${product.price.toFixed(2)}</span> <span class="sale-price">₱${product.salePrice.toFixed(2)}</span>`
